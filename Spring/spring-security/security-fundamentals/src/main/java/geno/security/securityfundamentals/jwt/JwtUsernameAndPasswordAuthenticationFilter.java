...
public class JwtUsernameAndPasswordAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request,
        ...
        UsernameAndPasswordAuthenticationRequest req;
        try {
            req = new ObjectMapper().readValue(request.getInputStream(), UsernameAndPasswordAuthenticationRequest.class);
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        String jwtToken = Jwts.builder()
                ...
                //.signWith(Keys.hmacShaKeyFor("sec5n74m864n34v5y7648b4769m57ure".getBytes()))
                .signWith(secretKey)
                .compact();
